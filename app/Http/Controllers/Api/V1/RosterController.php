...
class RosterController extends ApiController
{
    public function index()
    {
        ...
        return $this->successResponse([
            'products' => $roster ? ProductResource::collection($roster->products()->with(['store'=>fn($query)=>$query->orderBy('name'), 'category'=>fn($query)=>$query->orderBy('name')])->orderBy('name')->get()) : [],
